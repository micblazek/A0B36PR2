...
public abstract class Grafic {
    public abstract void drawSource(Expr source,int Scrol, JPanel panel,JScrollBar bar, Graphics g);
    
    public abstract void drawSource(String source,int Scrol, JPanel panel,JScrollBar bar, Graphics g);
